    ...
    <div className="space-y-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/api"
                className="inline-flex items-center px-8 py-4 bg-blue-700 text-white rounded-lg font-semibold hover:bg-blue-800 transition-all duration-300 neon-glow transform hover:scale-105"
              >
                get started
              ...
              <Link
                to="/demos"
                className="inline-flex items-center px-8 py-4 border-2 border-blue-700 text-blue-700 rounded-lg font-semibold hover:bg-blue-50 transition-all duration-300 transform hover:scale-105"
              >
                see demos
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full mt-2"></div>
                  <p className="text-slate-600">gen z ignores traditional survey formats</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full mt-2"></div>
                  <p className="text-slate-600">attention spans too short for lengthy questionnaires</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full mt-2"></div>
                  <p className="text-slate-600">brands need authentic insights from younger demographics</p>
                </div>
              </div>
            </div>
            <div className="glass-effect rounded-2xl p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-semibold text-slate-900">the insight gap</h3>
              </div>
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
                  <div className="text-sm text-blue-600 mb-1">insight ai surveys</div>
                  <div className="text-blue-800 font-semibold">85%+ completion rate in games</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-slate-600">players get rewards without watching ads</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-gradient-to-r from-green-500 to-green-600 rounded-full mt-2"></div>
                  <p className="text-slate-600">brands get authentic feedback from gen z</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-gradient-to-r from-green-500 to-green-600 rounded-full mt-2"></div>
                  <p className="text-slate-600">developers get better retention rates</p>
                </div>
              </div>
            </div>
            <div className="glass-effect rounded-2xl p-8">
              ...
              <div className="space-y-3 text-sm">
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-3 rounded-lg border border-blue-200">
                  <strong className="text-blue-700">ai character:</strong> 
                  <span className="text-slate-700"> "hey there, adventurer! before i give you those coins, 
                ...
                <div className="bg-gradient-to-r from-slate-50 to-slate-100 p-3 rounded-lg border border-slate-200">
                  <strong className="text-slate-600">player:</strong> 
                  <span className="text-slate-700"> "sure, what's up?"</span>
                </div>
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-3 rounded-lg border border-blue-200">
                  <strong className="text-blue-700">ai character:</strong> 
                  <span className="text-slate-700"> "what's your favorite type of mobile game?"</span>
                </div>
                <div className="space-y-2">
                  <button className="option-button w-full p-3 rounded-lg text-left text-slate-700 hover:text-blue-700">
                    🧩 puzzle games
                  </button>
                  <button className="option-button w-full p-3 rounded-lg text-left text-slate-700 hover:text-blue-700">
                    ⚔️ action games
                ...
                <div className="text-center text-blue-700 text-xs mt-4 font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="feature-card p-8 rounded-2xl">
                <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-100 to-blue-200 rounded-full mb-6">
      ...
      <section className="py-20 cta-gradient">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <Link
            to="/contact"
            className="inline-flex items-center px-8 py-4 bg-white text-blue-700 rounded-lg font-semibold hover:bg-blue-50 transition-all duration-300 neon-glow transform hover:scale-105"
          >
            join beta program
            <ArrowRight className="ml-2 h-5 w-5" />
          </Link>
