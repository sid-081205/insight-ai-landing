    ...
    <div className="space-y-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/api"
                className="inline-flex items-center px-8 py-4 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors neon-glow"
              >
                get started
            ...
            <div className="glass-effect rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div className="bg-gray-100 p-4 rounded-lg border border-gray-200">
                  <div className="text-sm text-gray-500 mb-1">traditional surveys</div>
                  <div className="text-gray-700">2-5% response rate from gen z</div>
                </div>
                <div className="bg-gray-100 p-4 rounded-lg border border-gray-200">
                  <div className="text-sm text-gray-500 mb-1">mobile game ads</div>
                  <div className="text-gray-700">zero meaningful data collection</div>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <div className="text-sm text-blue-600 mb-1">insight ai surveys</div>
                  <div className="text-blue-800">85%+ completion rate in games</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="glass-effect rounded-2xl p-8">
              <h3 className="text-xl font-semibold mb-4 text-gray-900">example interaction:</h3>
              <div className="space-y-3 text-sm">
                ...
                <div className="space-y-2">
                  <button className="option-button w-full p-3 rounded-lg text-left text-gray-700">
                    🧩 puzzle games
                  </button>
                  <button className="option-button w-full p-3 rounded-lg text-left text-gray-700">
                    ⚔️ action games
                ...
                <div className="text-center text-blue-600 text-xs mt-4">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <Link
            to="/contact"
            className="inline-flex items-center px-8 py-4 bg-white text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition-colors neon-glow"
          >
            join beta program
            <ArrowRight className="ml-2 h-5 w-5" />
          </Link>
