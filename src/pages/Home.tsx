...
const Home = () => {
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="py-10 bg-gradient-to-br from-cozy-50 via-sage-50 to-cozy-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-bold text-sage-900 mb-4">
          ...
          {/* Fun insight callout */}
          <div className="mt-6 bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-white/50">
            <div className="text-center">
      ...
      {/* Solution Overview */}
      <section className="py-10 bg-gradient-to-r from-sage-900 to-cozy-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Features */}
      <section className="py-10 bg-cozy-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-bold text-sage-900 mb-4">
      ...
      {/* CTA */}
      <section className="py-14 bg-gradient-to-r from-cozy-600 to-sage-600">
